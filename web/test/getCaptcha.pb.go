...
func (x *Response) Reset() {
	*x = Response{}
	mi := &file_proto_getCaptcha_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Response) Descriptor() ([]byte, []int) {
	return file_proto_getCaptcha_proto_rawDescGZIP(), []int{2}
}
...
func (x *StreamingRequest) Reset() {
	*x = StreamingRequest{}
	mi := &file_proto_getCaptcha_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*StreamingRequest) Descriptor() ([]byte, []int) {
	return file_proto_getCaptcha_proto_rawDescGZIP(), []int{3}
}
...
func (x *StreamingResponse) Reset() {
	*x = StreamingResponse{}
	mi := &file_proto_getCaptcha_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*StreamingResponse) Descriptor() ([]byte, []int) {
	return file_proto_getCaptcha_proto_rawDescGZIP(), []int{4}
}
...
const file_proto_getCaptcha_proto_rawDesc = "" +
	...
	"\x05count\x18\x01 \x01(\x03R\x05count2\x8c\x01\n" +
	"\n" +
	"GetCaptcha\x123\n" +
	"\x04Call\x12\x13.getCaptcha.Request\x1a\x14.getCaptcha.Response\"\x00\x12I\n" +
	"\x06Stream\x12\x1c.getCaptcha.StreamingRequest\x1a\x1d.getCaptcha.StreamingResponse\"\x000\x01B\x14Z\x12./order;getCaptchab\x06proto3"
...
var file_proto_getCaptcha_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_proto_getCaptcha_proto_goTypes = []any{
	(*Message)(nil),           // 0: getCaptcha.Message
	(*Request)(nil),           // 1: getCaptcha.Request
	(*Response)(nil),          // 2: getCaptcha.Response
	(*StreamingRequest)(nil),  // 3: getCaptcha.StreamingRequest
	(*StreamingResponse)(nil), // 4: getCaptcha.StreamingResponse
}
var file_proto_getCaptcha_proto_depIdxs = []int32{
	1, // 0: getCaptcha.GetCaptcha.Call:input_type -> getCaptcha.Request
	3, // 1: getCaptcha.GetCaptcha.Stream:input_type -> getCaptcha.StreamingRequest
	2, // 2: getCaptcha.GetCaptcha.Call:output_type -> getCaptcha.Response
	4, // 3: getCaptcha.GetCaptcha.Stream:output_type -> getCaptcha.StreamingResponse
